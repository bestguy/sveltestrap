...
addons.setConfig({
  theme: create({
    base: 'light',
    brandTitle: `<span class="d-flex align-items-center justify-content-center" style="display: flex; align-items: center; color: purple; font-weight: 400; letter-spacing: 0.1rem;">
